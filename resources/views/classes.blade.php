...
<head>
	...
	<link rel="stylesheet" href="/frontend/ahana/css/magnific-popup.css"/>
		...
		<div class="header-bottom">
			...
			<div class="container">
				<ul class="main-menu">
					...
					<li><a href="classes" class="active">Classes</a>
						<ul class="sub-menu">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-5 col-sm-8 sidebar">
					...
					<div class="sb-widget">
						<div class="sb-video">
							<img src="/frontend/ahana/img/video.jpg" alt="">
							<a href="https://www.youtube.com/watch?v=vgv-hzTl5FA" class="video-popup"><img src="/frontend/ahana/img/icons/play.png" alt=""></a>
						</div>
					</div>
				</div>
			</div>
