				...
				<ul class="main-menu">
                    ...
                    <li><a>Tentang Kami</a>
						<ul class="sub-menu">
							...
							<li><a href="visimisi" class="active">Visi Misi & Tujuan Pendidikan</a></li>
						</ul>
                    </li>
				...
				<div class="trainer-info">
					...
					<div class="td-right">
						...
						<ul>
                            ...
                            <li><strong>4.</strong><p>Peningkatan daya nalar keagamaan serta berperilaku positif</p></li>
                            <li><strong>5.</strong><p>Memperkokoh ukhuwah Islamiyah antar siswa, antar orangtua siswa, antar masyarakat dan keluarga besar Pondok Pesantren Daarul Qolam</p></li>
