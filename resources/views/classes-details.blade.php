				...
				<div class="col-lg-9">
					<div class="classes-details">
						<div class="classes-preview">
							<img src="/frontend/ahana/img/classes/big.jpg" alt="">
						</div>
						<div class="row">
							<div class="col-lg-8">
								<h2>Yoga Therapy</h2>
						...
						<div class="row mb-5">
							<div class="col-lg-5">
								<img src="/frontend/ahana/img/classes/classes-details.png" alt="">
							</div>
							<div class="col-lg-7">
					...
					<div class="classes-other-slider owl-carousel">
						<div class="classes-item">
							<div class="ci-img">
								<img src="/frontend/ahana/img/classes/1.jpg" alt="">
							</div>
							<div class="ci-text">
						...
						<div class="classes-item">
							<div class="ci-img">
								<img src="/frontend/ahana/img/classes/2.jpg" alt="">
							</div>
							<div class="ci-text">
						...
						<div class="classes-item">
							<div class="ci-img">
								<img src="/frontend/ahana/img/classes/3.jpg" alt="">
							</div>
							<div class="ci-text">
								<h4>Yoga Therapy</h4>
								<div class="ci-metas">
